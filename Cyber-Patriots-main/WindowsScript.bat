...
:menu
	...
	echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	echo "1)Set user properties		4)Change all passwords"
	echo "5)Disable guest/admin		6)Set passwor d policy"
...
::SHould try to make a user managment function where you can copy and paste from readme
::and it automaticaly deletes users that arent supposed to be there and adds users that are	
:disUser
	cls
	net users
...
:badFiles
::I will do unholy things to whoever fills out this function
::Jpegs
::jpgs
::mp4
::mp3
